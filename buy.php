...
<body background="https://user-images.githubusercontent.com/41795172/115334956-262f7780-a151-11eb-9fec-d9e708bcaaef.jpg">
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand h1" href="index.php"><i class="fas fa-couch" aria-hidden="true"></i> GROCERY STORE</a>
...
<div class="container">
  ...
  <div class="table-responsive">
    ...
    <div class="container" ng-app="shoppingCart" ng-controller="shoppingCartController" ng-init="loadProduct(); fetchCart();">
      <h3 align="center"> <i class="fas fa-shopping-basket"></i> Your Order Summary</h3>
